...
import team8.catan.players.strategy.ActionSelectionPolicy;
...
public class RandomAgent extends Player {
    ...
    private final ActionSelectionPolicy selectionPolicy;
    ...
    public RandomAgent(int id, PlayerColor color, Random random) {
        this(
            ...
            color,
            random,
            new ValueBasedActionSelectionPolicy(new ImmediateValueStrategy(random))
        );
    }

    public RandomAgent(int id, PlayerColor color, ActionSelectionPolicy selectionPolicy) {
        this(id, color, new Random(), selectionPolicy);
    }

    public RandomAgent(int id, PlayerColor color, Random random, ActionSelectionPolicy selectionPolicy) {
        super(id, color);
